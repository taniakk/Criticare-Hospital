(function($) {
	...
	if($('.sticky-header').length){
		var navContainer = $('.main-header .nav-outer, .main-header .header-nav-row');
		var stickyMenuContent = "";
		if(navContainer.length){
			stickyMenuContent = navContainer.html();
		} else if($('.main-header .main-menu').length) {
			stickyMenuContent = $('.main-header .main-menu')[0].outerHTML;
		}
	...
	if($('.clock-wrapper').length){  
		(function(){
            ...
            var now       = new Date(),
             ...
             var clockAnim = document.getElementById("clock-animations");
             if (clockAnim) {
                 clockAnim.innerHTML = stylesDeg;
             }
         })();
    }
